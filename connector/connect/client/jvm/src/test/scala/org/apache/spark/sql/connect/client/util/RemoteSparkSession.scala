...
object SparkConnectServerUtils {
  ...
  private def testConfigs: Seq[String] = {
    ...
    val udfStubTestConfigs = Seq(
      "--conf",
      "spark.connect.scalaUdf.stubClasses=" +
        "org.apache.spark.sql.connect.client, org.apache.spark.sql.connect")

    jarsConfigs ++ writerV2Configs ++ hiveTestConfigs ++ udfStubTestConfigs
  }
